...
from .Views.companies import companies_list_create, company_detail_update
from .Views.customers import customers_list_create, customer_detail_update
...
urlpatterns = [
    ...
    # Companies
    path("companies/", companies_list_create),
    path("companies/<str:company_id>/", company_detail_update),
